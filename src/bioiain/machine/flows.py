...
def predict(file_path, model_data_path, chain_id="A", use_temp=True, force=False, timestamp=False, with_foldseek=True, foldseek_cmd="foldseek"):
    ...
    print(monomer)
    embedding = SaProtEmbedding(entity=monomer, folder=prediction_folder, force=force, with_foldseek=with_foldseek, foldseek_cmd=foldseek_cmd)
