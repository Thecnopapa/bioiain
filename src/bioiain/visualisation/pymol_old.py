...
from ..utilities.maths_old import *
...
def pymol_list_to_bfactors(val_list, obj_name, resids, paint=True):
...
def pymol_split_states(obj_name, start=1, end = 0):
    pymol.cmd.split_states(obj_name, first=start, last=end)
